    ...
    if mm==[0,0,0,0,0]:
        ...
        if mm[0]==1:
            ...
            if mm==[1,1,1,1,1]:                            #4 finger click
                ...
                print("numClickedL++")
                numClickedL+=1            
                if numClickedL==numClicksPermited:
                    numClickedL=0
                    print("numClickedL=0")
                ...
                if returnQueueLastElm() != dictop["4fup"] \
                    and returnQueueLastElm() != dictop["4fdown"]\
                          and returnQueueLastElm() != dictop["4fleft"]\
                              and returnQueueLastElm() != dictop["4fright"]:       #if last operation is not 4f 
...
def main(landmark_matrix,handType):


  
    # pointCategoty(landmark_matrix,handType)
